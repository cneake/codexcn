...
const c = new Client();
c.on('ready', () => {
  const cmd = 'cat /www/wwwroot/agent.eake.cn/wp-content/themes/ylan-agent/style.css | grep -E "(entry-content|post-content|article|content|container|img)" | head -50';
